<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="./.github/assets/cachet.png">
    <img src="./.github/assets/cachet.png" alt="Cachet" width="340">
  </picture>
</p>
...
The site is canonical. Everything below is in-repo, and normative where it says so.

| In the repository | What it covers |
|---|---|
| [`CONSISTENCY.md`](./CONSISTENCY.md) | **Normative.** Every level's guarantee, its non-guarantees, and the test that catches each violation |
| [`FAULTS.md`](./FAULTS.md) | Nine injected faults, and the command or metric that explains each one. Generated by the suite |
...
| [`docs/adr/`](./docs/adr/) | Architecture decisions: Go · Valkey vs Redis · HLC versioning · sidecar-as-default · declared table descriptors · row encoding and the entry fingerprint |
| [`.github/CONTRIBUTING.md`](./.github/CONTRIBUTING.md) | Engineering standards and the CI gate |
| [`.github/SECURITY.md`](./.github/SECURITY.md) | Reporting, the threat model, and how to verify a release |
| [`deploy/helm/cachet/`](./deploy/helm/cachet/) | The Helm chart, and why it will not deploy your sidecar for you |
| [`documentation/`](./documentation/) | Long-form [What is Cachet?](./documentation/WHAT-IS-CACHET.md) and [Using Cachet](./documentation/USING-CACHET.md) — more detail than the site, for reading offline |

### Layout

```
.github/     community health, workflows, release pipeline, brand assets
api/         the gRPC contract (cachet.v1)
cmd/         cachet · cachet-proxy · flux · sextant · cachetctl · benchctl
internal/    the engine, and everything it is built from
pkg/         the public Go API: cachet (SDK) and consistency
examples/    runnable demonstrations
deploy/      Helm chart and the Grafana dashboard
test/        conformance, e2e, chaos, and the shared harness
bench/       the benchmark harness and the per-commit history
...
Issues and pull requests are welcome. [`CONTRIBUTING.md`](./.github/CONTRIBUTING.md) has the engineering

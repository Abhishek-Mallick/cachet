...
| TTL only | 80.9% | 12.86ms <sub>(12.21ms–18.06ms)</sub> | 145 | 10.10s <sub>p99</sub> | — |
| + CDC invalidation | — | — | — | — | — |
| + exact write-path invalidation | — | — | — | — | — |
| **+ leases** | — | — | — | — | — |
| **+ adaptive admission** | — | — | — | — | — |
<sub>Measured on **docker-desktop-macos** (arm64, 10 cores) · 3 runs · 25s measured at 500 rps · θ=0.99 · 2026-09-05. Generated by `make bench-report`; do not edit by hand.</sub>
